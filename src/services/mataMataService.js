...
const KNOCKOUT_OFFICIAL_RESULTS = {
  ...
  99: { officialM: 1, officialV: 2, winner: 'B' }, // Noruega x Inglaterra
  100: { officialM: 3, officialV: 1, winner: 'A' }, // Argentina x Suíça

  // Semifinais
  101: { officialM: null, officialV: null, winner: '' }, // França x Espanha
